...
const CLUSTERS = [
  ...
  },
  {
    ...
    note: 'Turning APIs and data into interfaces people actually enjoy using.',
  },
  {
    id: 'backend',
    label: 'Backend',
    title: 'Systems',
    items: ['Node.js', 'Express', 'MongoDB', 'MySQL', 'PostgreSQL'],
    note: 'APIs, schemas, and the data layer underneath every product.',
  },
  {
    id: 'ai',
    label: 'AI & Analytics',
    title: 'Intelligence',
    items: ['Linear Regression', 'Logistic Regression', 'Hypothesis Testing', 'KPI Analysis'],
    note: 'The statistical grounding behind AI-powered product decisions.',
  },
]
