...
const JOBS = [
  {
    ...
    current: true,
    points: [
      'Developed responsive web applications using React, JavaScript, HTML, CSS, and Node.js, translating functional requirements into user-focused solutions.',
      'Integrated frontend interfaces with backend APIs to deliver dynamic features and improve application performance.',
      'Utilized Git and GitHub for version control, code collaboration, and maintaining an efficient development workflow.',
    ],
    stack: ['React', 'JavaScript', 'HTML', 'CSS', 'Node.js', 'Git'],
  },
  {
    ...
    current: false,
    points: [
      'Developed a scalable AI-powered Question Bank Generation platform using React, Node.js, Express.js, PostgreSQL, and Prisma, enabling automated question creation and management.',
      'Translated application requirements into secure technology solutions by designing RESTful APIs, authentication, role-based access control (RBAC), and optimized backend services.',
      'Integrated web scraping from LeetCode, CodeChef, Codeforces, and HackerRank to build a centralized repository of coding questions with advanced search and filtering.',
      'Collaborated with the development team using Git and GitHub to design, develop, test, and deploy scalable application features.',
    ],
